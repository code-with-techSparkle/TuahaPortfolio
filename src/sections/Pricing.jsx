  ...
  return (
    <section>
      <Element name="pricing">
        <div className="container mb-5 pt-0 mt-0">
          <div className="max-w-960 relative mx-auto border-s2 bg-#fff pb-40 pt-28 max-xl:max-w-4xl max-lg:border-none max-md:pb-32 max-md:pt-16">
              ...
              >
                ...
                >
                  <img
                    ...
                    alt={plan.title}
                    className={clsx(
                      "object-contain rounded-full drop-shadow-2xl ",
                ...
                <ul className="mx-auto space-y-4 xl:px-7 ">
                    {plan.features.map((feature) => (
                        <li key={feature} className="relative flex items-center  gap-5">
                            <img src={"/images/check.png"} className="size-7 object-contain" alt="check" />
